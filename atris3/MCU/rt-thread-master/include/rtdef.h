...
#define RT_DEVICE_CTRL_RTC_SET_ALARM_AF 0x14            /**< set or clear alarm interrupt */
#define RT_DEVICE_CTRL_RTC_SET_ALARM_AIE 0x15           /**< enable or disable alarm interrupt */
