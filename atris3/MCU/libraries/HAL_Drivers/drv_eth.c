...
ALIGN(RT_ALIGN_SIZE)
static rt_uint8_t s_RxBuffer[ETH_RXBUFNB][ETH_MAX_PACKET_SIZE];
ALIGN(RT_ALIGN_SIZE)
static rt_uint8_t s_TxBuffer[ETH_TXBUFNB][ETH_MAX_PACKET_SIZE];
ALIGN(RT_ALIGN_SIZE)
static ETH_DMADescTypeDef s_DMARxDscrTabBuffer[ETH_RXBUFNB];
ALIGN(RT_ALIGN_SIZE)
static ETH_DMADescTypeDef s_DMATxDscrTabBuffer[ETH_TXBUFNB];
...
static int rt_hw_stm32_eth_init(void)
{
    ...
    DMARxDscrTab = (ETH_DMADescTypeDef *)s_DMARxDscrTabBuffer;
    ...
    DMATxDscrTab = (ETH_DMADescTypeDef *)s_DMATxDscrTabBuffer;
