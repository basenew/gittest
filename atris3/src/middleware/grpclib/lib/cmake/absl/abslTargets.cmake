...
add_library(absl::dynamic_annotations SHARED IMPORTED)
...
set_target_properties(absl::symbolize PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::debugging_internal;absl::demangle_internal;absl::base;absl::config;absl::core_headers;absl::dynamic_annotations;absl::malloc_internal;absl::raw_logging_internal"
)
...
set_target_properties(absl::flags_internal PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::base;absl::config;absl::flags_config;absl::flags_handle;absl::flags_registry;absl::synchronization"
)
...
set_target_properties(absl::flags_handle PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::flags_config;absl::flags_marshalling;absl::core_headers;absl::optional;absl::raw_logging_internal;absl::strings;absl::synchronization"
)

# Create imported target absl::flags_registry
add_library(absl::flags_registry SHARED IMPORTED)

set_target_properties(absl::flags_registry PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::flags_config;absl::flags_handle;absl::core_headers;absl::raw_logging_internal;absl::strings;absl::synchronization"
)
...
set_target_properties(absl::flags PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::flags_config;absl::flags_handle;absl::flags_internal;absl::flags_marshalling;absl::flags_registry;absl::base;absl::core_headers;absl::strings"
)
...
set_target_properties(absl::flags_usage_internal PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::flags_config;absl::flags;absl::flags_handle;absl::flags_internal;absl::flags_path_util;absl::flags_program_name;absl::flags_registry;absl::strings;absl::synchronization"
)
...
set_target_properties(absl::flags_parse PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::core_headers;absl::flags_config;absl::flags;absl::flags_handle;absl::flags_internal;absl::flags_program_name;absl::flags_registry;absl::flags_usage;absl::strings;absl::synchronization"
)
...
set_target_properties(absl::random_bit_gen_ref PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::core_headers;absl::random_internal_distribution_caller;absl::random_internal_fast_uniform_bits;absl::random_internal_mocking_bit_gen_base;absl::type_traits"
)
...
set_target_properties(absl::random_internal_mocking_bit_gen_base PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::random_random;absl::strings"
)
...
set_target_properties(absl::random_internal_uniform_helper PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::core_headers;absl::random_internal_fast_uniform_bits;absl::random_internal_iostream_state_saver;absl::random_internal_traits;absl::type_traits"
)
...
set_target_properties(absl::status PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::core_headers;absl::raw_logging_internal;absl::inlined_vector;absl::stacktrace;absl::symbolize;absl::strings;absl::cord;absl::str_format;absl::optional"
)
...
set_target_properties(absl::cord PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::strings_internal;absl::base;absl::base_internal;absl::core_headers;absl::endian;absl::fixed_array;absl::function_ref;absl::inlined_vector;absl::raw_logging_internal;absl::type_traits"
)
