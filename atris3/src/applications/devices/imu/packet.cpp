...
void Packet::crc16_update(uint16_t *currectCrc, const uint8_t *src, uint32_t lengthInBytes)
{
...
uint32_t Packet::Packet_CreatePing(Packet_t *pkt)
{
    pkt->buf[0] = 0x5A;
    pkt->buf[1] = 0xA6;
    pkt->payload_len = 0;
...
uint32_t Packet::Packet_CreatePingAck(Packet_t *pkt, uint8_t major, uint8_t minor, uint8_t bugfix, uint16_t option)
{
    pkt->buf[0] = 0x5A;
    pkt->buf[1] = 0xA7;
...
uint32_t Packet::Packet_Begin(Packet_t *pkt)
{
...
uint32_t Packet::Packet_AddData(Packet_t *pkt, uint8_t *buf, uint16_t len)
{
...
uint32_t Packet::Packet_Final(Packet_t *pkt)
{
 ...
 * @retval None
 */
void Packet::Packet_DecodeInit(Packet_t *pkt, OnDataReceivedEvent Func)
{
    EventHandler = Func;
 ...
 * @retval CH_OK
 */
uint32_t Packet::Packet_Decode(uint8_t c)
{
